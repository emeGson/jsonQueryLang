...
try {
    ...
    Deno.test('combinators float', () => {
        assertEquals(Float(createTokenizer('234.45')), { raw: '234.45', idx: 0, type: 'float', children: [] })
    ...
    Deno.test('combinators string literal', () => {
        assertEquals(StringLiteral(createTokenizer('hello'), 'hello'), { raw: 'hello', idx: 0, type: 'stringLiteral', children: [] })
        assertEquals(StringLiteral(createTokenizer('hello world'), 'hello'), { raw: 'hello', idx: 0, type: 'stringLiteral', children: [] })
    ...
    Deno.test('combinators boolean', () => {
        assertEquals(Boolean(createTokenizer('true')), { raw: 'true', idx: 0, type: 'boolean', children: [] })
        assertEquals(Boolean(createTokenizer('false')), { raw: 'false', idx: 0, type: 'boolean', children: [] })
        assertEquals(Boolean(createTokenizer('yolo')), null)
    })

    Deno.test('combinators identifier', () => {
        assertEquals(Identifier(createTokenizer('true')), { raw: 'true', idx: 0, type: 'identifier', children: [] })
        assertEquals(Identifier(createTokenizer('_false')), { raw: '_false', idx: 0, type: 'identifier', children: [] })
        assertEquals(Identifier(createTokenizer('12312yolo')), null)
    })

    Deno.test('combinators zeroOrMore', () => {
        assertEquals(ZeroOrMore(createTokenizer('true'), Boolean), [{ raw: 'true', idx: 0, type: 'boolean', children: [] }])
        ...
        assertEquals(ZeroOrMore(createTokenizer('truefalsetrue'), (t) => SequenceOf(t, [
            Boolean, Boolean
        ])), [
    ...
    Deno.test('combinators maybe', () => {
        assertEquals(Maybe(createTokenizer('true'), Boolean), { raw: 'true', idx: 0, type: 'boolean', children: [] })
        assertEquals(Maybe(createTokenizer('_false'), Boolean), [])
        assertEquals(Maybe(createTokenizer('arg1'), (t) => SequenceOf(t, [
            Identifier,
            (t) => ZeroOrMore(t, (t) => SequenceOf(t, [
                (t) => StringLiteral(t, ','),
                Identifier
            ]))
        ])), [
        ...
        assertEquals(Maybe(createTokenizer('arg1,arg2,arg3'), (t) => SequenceOf(t, [
            Identifier,
            (t) => ZeroOrMore(t, (t) => SequenceOf(t, [
                (t) => StringLiteral(t, ','),
                Identifier
    ...
    Deno.test('combinators choice', () => {
        assertEquals(Choice(createTokenizer('true'), [
            Boolean,
            Int
        ]), { raw: 'true', idx: 0, type: 'boolean', children: [] })
        assertEquals(Choice(createTokenizer('34'), [
            Boolean,
            Int
        ]), { raw: '34', idx: 0, type: 'int', children: [] })
        assertEquals(Choice(createTokenizer('truefalse'), [
            (t) => SequenceOf(t, [Boolean, Boolean]),
            Int
        ]), [{ type: 'boolean', raw: 'true', idx: 0, children: [] }, { type: 'boolean', raw: 'false', idx: 4, children: [] }])
        assertEquals(Choice(createTokenizer('truefalse'), [
    ...
    Deno.test('combinators sequenceOf', () => {
        assertEquals(SequenceOf(createTokenizer('truefalsetrue'), [
        ...
        assertEquals(SequenceOf(createTokenizer('truefalse'), [
            Boolean, Boolean,
            (t) => Maybe(t, Boolean)
        ]), [
    ...
    Deno.test('combinators function arguments', () => {
        assertEquals(FunctionArguments(createTokenizer('()')), { type: 'arguments', raw: '()', idx: 0, children: [] })
    ...
    Deno.test('combinators expression', () => {
        ...
        assertEquals(Expression(createTokenizer('t.*.t')), {
            type: 'expression', raw: 't.*.t', idx: 0, children: [
                { type: 'identifier', raw: 't', idx: 0, children: [] },
                { type: 'wildcard', raw: '*', idx: 2, children: [] },
            ...
            type: 'function', raw: '>s(arg1)', idx: 0, children: [
                { type: 'identifier', raw: 's', idx: 1, children: [] },
                {
                    type: 'arguments', raw: '(arg1)', idx: 2, children: [
                        {
                            type: 'expression', raw: 'arg1', idx: 3, children: [
    ...
    Deno.test('test parsing simple property', () => {
        assertEquals(parse('propertyName'),
            {
                type: 'expression', raw: 'propertyName', idx: 0, children: [
    ...
    Deno.test('test parsing only atoms', () => {
        assertEquals(parse('profile.location.lat'),
            {
                type: 'expression', raw: 'profile.location.lat', idx: 0, children: [
